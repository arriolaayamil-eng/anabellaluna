...
import { FaEnvelope, FaPlus, FaPlay, FaPause, FaEdit, FaTrash, FaChartLine, FaUsers, FaEye, FaMousePointer, FaBullhorn } from 'react-icons/fa';
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          <h2 className={`text-lg font-semibold flex items-center gap-2 ${isDark ? 'text-white' : 'text-gray-900'}`}>
            <FaBullhorn className="text-purple-500" /> Campañas de Marketing
          </h2>
          <p className={`text-sm mt-1 ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>Gestión de campañas activas</p>
        </div>
        <button
          type="button"
