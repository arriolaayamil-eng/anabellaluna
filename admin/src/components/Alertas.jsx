...
const Alertas = () => {
  ...
  const loadNotifications = useCallback(async () => {
    try {
      setLoading(true);
      // Trigger generation of new notifications from real events, then fetch
      await notificationService.generateNotifications().catch(() => {});
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            onClick={() => {
              ...
              notificationService.clearReadNotifications().catch(() => {});
            }}
          >
            Limpiar leídas
          </button>
