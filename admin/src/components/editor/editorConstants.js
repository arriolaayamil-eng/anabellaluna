...
export const THEME = {
  light: {
    bg: '#F2F2F7', card: '#FFFFFF', cardAlt: '#F9FAFB', border: 'rgba(60,60,67,0.12)',
    text: '#000000', text2: '#3C3C43', text3: '#8E8E93', accent: '#007AFF',
    success: '#34C759', danger: '#FF3B30', hover: '#E5E5EA',
  },
  dark: {
    bg: '#202124', card: '#292A2D', cardAlt: '#333336', border: 'rgba(255,255,255,0.08)',
    text: '#E8EAED', text2: '#BDC1C6', text3: '#9AA0A6', accent: '#0A84FF',
