...
/** Wait until SVGs inside a container have dimensions > 0 */
...
function drawCover(doc, cfg) {
  ...
  doc.setFontSize(30);
  doc.setFont('helvetica', 'bold');
  doc.text('REPORTE CRM', A4_W / 2, 75, { align: 'center' });

  doc.setFontSize(15);
  doc.setFont('helvetica', 'normal');
  doc.text('Sistema CRM Inmobiliario', A4_W / 2, 102, { align: 'center' });
  ...
  doc.setFontSize(10);
  const sections = ['Gráficos y Métricas', 'Resumen Consolidado'];
