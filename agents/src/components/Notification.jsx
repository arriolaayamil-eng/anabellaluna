      ...
      <div className="flex-1 overflow-y-auto space-y-1">
        ...
        {notifications.map((notif) => (
          <div
            ...
            className={`flex items-start gap-3 p-3 rounded-lg cursor-pointer transition-all ${prioridadColors[notif.prioridad] || ''} ${notif.leida ? 'opacity-60' : 'bg-blue-50/50 dark:bg-blue-900/10 hover:bg-blue-50 dark:hover:bg-blue-900/20'}`}
          >
