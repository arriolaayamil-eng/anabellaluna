...
const Seguridad = () => {
  ...
  // Setup flow
  const [setupStep, setSetupStep] = useState(null); // null | 'qr' | 'codes'
          ...
          <div className="p-6 rounded-2xl border border-gray-200 dark:border-gray-700/50">
            ...
            <form onSubmit={handleVerifySetup} className="space-y-3">
              <input
                ...
                className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700/70 text-center text-2xl font-mono tracking-[0.3em] focus:outline-none focus:ring-2 focus:ring-sky-500 dark:bg-gray-900/40 dark:text-gray-100"
                placeholder="000000"
                autoFocus
                required
              />
          ...
          <div className="p-6 rounded-2xl border border-blue-200 dark:border-blue-500/30">
            ...
            <form onSubmit={handleRegenCodes} className="space-y-3">
              <input
                ...
                className="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700/70 focus:outline-none focus:ring-2 focus:ring-sky-500 dark:bg-gray-900/40 dark:text-gray-100"
                placeholder="Contraseña actual"
                required
              />
              <input
                ...
                className="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700/70 text-center font-mono tracking-wider focus:outline-none focus:ring-2 focus:ring-sky-500 dark:bg-gray-900/40 dark:text-gray-100"
