  ...
  return (
    <>
      <div className="page-wrapper">
        <Breadcrumb title="Alquileres - Mapa" paths={[{ label: "Propiedades en Alquiler", active: true }]} />
                  ...
                  <div className="col-lg-9">
                    <div className="d-flex align-items-center gap-3 flex-wrap justify-content-lg-end flex-lg-row flex-md-row flex-column">
                      ...
                      <ul className="grid-list-view d-flex align-items-center justify-content-center">
                        <li>
                          <Link to={all_routes.rentPropertyGridSidebar} className="list-icon">
                            <i className="material-icons">grid_view</i>
                          </Link>
                        </li>
                        <li>
                          <Link to={all_routes.rentPropertyListSidebar} className="list-icon active">
