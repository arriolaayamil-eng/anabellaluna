  ...
  return (
    <>
      <div className="page-wrapper">
        <Breadcrumb title="Propiedades en Venta - Mapa" paths={[{ label: "Propiedades en Venta", active: true }]} />
          ...
          <div className="container">
                  ...
                  <div className="col-lg-9">
                    <div className="d-flex align-items-center gap-3 flex-wrap justify-content-lg-end flex-lg-row flex-md-row flex-column">
                      ...
                      <ul className="grid-list-view d-flex align-items-center justify-content-center">
                        <li>
                          <Link to={all_routes.buyPropertyGridSidebar} className="list-icon active">
                            <i className="material-icons">grid_view</i>
                          </Link>
                        </li>
                        <li>
                          <Link to={all_routes.buyPropertyListSidebar} className="list-icon">
            ...
            <div className="row">
                ...
                <div className="row mb-4">
                  ...
                  {!isLoading && properties.length === 0 && (
                    <div className="col-12 text-center py-5">
                      ...
                      <p className="mt-2 text-muted">No se encontraron propiedades.</p>
                    </div>
                  )}
              ...
              <div className="col-lg-5">
                <div className="map-placeholder bg-light rounded d-flex align-items-center justify-content-center" style={{ height: 600, position: "sticky", top: 100 }}>
                  <div className="text-center text-muted">
                    <i className="material-icons-outlined" style={{ fontSize: 48 }}>map</i>
